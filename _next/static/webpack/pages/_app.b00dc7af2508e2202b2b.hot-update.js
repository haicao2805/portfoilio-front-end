...
var Navbar = function Navbar() {
  ...
  return __jsx("div", {
    ...
    className: "duration-300 transform cursor-pointer hover:scale-110 hover:bg-yellow-500",
    __self: _this,
    __source: {
      fileName: _jsxFileName,
      lineNumber: 45,
